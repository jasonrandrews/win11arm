...
Write-Output "Setting up this Virtual Machine... please do not close this window! This VM will shutdown once done."
...
Execute-Command 'reg add "HKLM\SYSTEM\CurrentControlSet\Control\Terminal Server\WinStations\RDP-Tcp" /v fNegotiateSecurityLayer /t REG_DWORD /d 0 /f'
...
# Prevent "your password has expired and must be changed" after 42 days 
